...
- (id)initWithFrame:(CGRect)frame 
{
    if ((self = [super initWithFrame:frame])) 
	{
        ...
        self.backgroundColor = [UIColor colorWithRed:0.203922 green:0.215686 blue:0.274510 alpha:1];
        ...
        self.pagesScrollView.backgroundColor = [UIColor colorWithRed:0.203922 green:0.215686 blue:0.274510 alpha:1];
...
//		self.pagesScrollView.delaysContentTouches = YES;
        ...
        self.pageControl.backgroundColor = [UIColor colorWithRed:0.203922 green:0.215686 blue:0.274510 alpha:1];
...
-(void)layoutItems
{
    ...
    int curRowCount = [[self.pages objectAtIndex:0] count]/portraitColumnCount;
...
-(void)touchesMoved:(NSSet *)touches withEvent:(UIEvent *)event
{
	...
	if(dragging) 
	{
		...
		{
            NSMutableArray *itemPage1 = [self.pages objectAtIndex:0];
            MyLauncherItem *itemToMove = [itemPage1 objectAtIndex:0];
            CGRect dragRectMove = itemToMove.frame;
